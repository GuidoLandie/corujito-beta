    ...
    public class CRJPessoaNegocio
    {
        ...
        public CRJPessoa ObterCRJPessoaPorId(int pIdPessoa)
        {
            ...
            using (DbCommand dbCommand = db.GetStoredProcCommand("STPCRJPessoa04"))
            {
                ...
                db.AddInParameter(dbCommand, "pNome", DbType.String, DBNull.Value);
        ...
        private void SalvarTipoPessoa(int IdPessoa, List<CRJTipoPessoa> listTipoPessoa)
        {
            ...
            //Removoe todo mundo
            using (DbCommand dbCommand = db.GetStoredProcCommand("STPCRJPessoaXTipo02"))
            {
            ...
            if (listTipoPessoa != null && listTipoPessoa.Count > 0)
            {
                ...
                {
                    //Insere todo mundo
                    using (DbCommand dbCommand = db.GetStoredProcCommand("STPCRJPessoaXTipo01"))
                    {
        ...
        public List<CRJPessoa> ObterDependentesDisponiveis()
        {
            ...
            Database db = Microsoft.Practices.EnterpriseLibrary.Data.DatabaseFactory.CreateDatabase("BancoSistema");
            using (DbCommand dbCommand = db.GetStoredProcCommand("STPCRJPessoa10"))
            {
