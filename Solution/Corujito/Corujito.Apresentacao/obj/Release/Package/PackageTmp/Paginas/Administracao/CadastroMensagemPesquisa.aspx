<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CadastroMensagemPesquisa.aspx.cs" Inherits="Corujito.Apresentacao.Paginas.Administracao.CadastroMensagemPesquisa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <u>Home > Administração > Cadastro Mensagem</u>

    <br />
    <br />
    
     <ext:Panel ID="pnlTituloPagina" runat="server" AnchorHorizontal="100%" Title="Mensagems" Icon="User" Frame="true" Border="true"
		...
		<ext:Panel ID="PanelParametrosPesquisa" runat="server" Title="Parâmetros da Pesquisa" Icon="Magnifier" AnchorHorizontal="100%"
			...
			<ext:GridPanel ID="GridPesquisaCRJPessoa" runat="server" StripeRows="true" Title="Resultados da pesquisa - Cadastro de Pessoas" Icon="Table" TrackMouseOver="true"
				...
				<Store>
					<ext:Store ID="StoreCRJMensagem" runat="server" >
						<Reader>
							<ext:JsonReader>
								<Fields>
                                    ...
                                    <ext:RecordField Name="IdMensagem"      Mapping="IdMensagem" Type="Int"/>
                                    <ext:RecordField Name="Mensagem"      Mapping="Mensagem" Type="String"/>
                                    <ext:RecordField Name="DataMensagem"      Mapping="DataMensagem" Type="Date"/>
				...
				<ColumnModel ID="ColumnModel1" runat="server">
					<Columns>
                        ...
                        <ext:Column ColumnID="DataMensagem" Header="DataMensagem" DataIndex="DataMensagem"  Align="Left"/>
                        <ext:Column ColumnID="Mensagem" Header="Mensagem" DataIndex="Mensagem"  Align="Left"/>
                ...
                <View>
                    <ext:GridView ID="gvMensagem" runat="server" ForceFit="true"></ext:GridView>
                </View>
				...
				<DirectEvents>
					<Command OnEvent="LinhaGrid_DirectClick">
						<EventMask ShowMask="true" MinDelay="10" />
						<ExtraParams>
							<ext:Parameter Value="record.data.IdMensagem" Mode="Raw" Name="IdentificadorRegistroTabela"></ext:Parameter>
