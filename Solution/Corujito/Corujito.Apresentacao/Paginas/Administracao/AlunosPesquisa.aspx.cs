...
{
    public partial class AlunosPesquisa : System.Web.UI.Page
    {
        ...
        private void PopularGrid(string pNome = null, string pEmail = null, string pCPF = null,string pTelefone=null, string pRA = null)
        {
            ...
            CRJAlunoNegocio objCRJAlunoNegocio = new CRJAlunoNegocio();
           

            //Atribuindo ao objeto de coleção os registros encontrados na pesquisa.
            DataTable dtOcorrencia = objCRJAlunoNegocio.ObterCRJAluno(pNome, pEmail, pCPF, pTelefone, pRA);
       ...
       /// <param name="e"></param>
        protected void LinhaGrid_DirectClick(object sender, DirectEventArgs e)
        {
            ...
            if (e.ExtraParams["IDObjeto"] == "btnOcorrencia")
            {
                string URL = "CadastroOcorrenciaAluno.aspx?qIDAluno=" + IDTabela;
                Response.Redirect(URL);
            }

            //Se o click foi no botão Alterar.
            if (e.ExtraParams["IDObjeto"] == "btnEmail")
            {
                string URL = "CadastroMensagem.aspx?qIDAluno=" + IDTabela;
                Response.Redirect(URL);
            }
