<%@ Page Title="" Language="C#" MasterPageFile="~/Modal.Master" AutoEventWireup="true" CodeBehind="CadastroGrupoPermissoes.aspx.cs" Inherits="Corujito.Apresentacao.Paginas.Administracao.CadastroGrupoPermissoes" %>
						...
						<ext:Button ID="btnGravar" runat="server" Icon="Disk" Text="Gravar" Height="25" Width="110" ToolTip="Gravar dados." >
							<DirectEvents>
								<Click OnEvent="btnGravar_Click">	
                                     <ExtraParams>
                                        <ext:Parameter Name="Values" Value="Ext.encode(#{GridFuncionalidades}.getRowsValues({selectedOnly:true}))" Mode="Raw" />
                                    </ExtraParams>							
								</Click>
							</DirectEvents>
						</ext:Button>
