...
{
    public partial class CadastroPermissaoUsuarioPesquisa : System.Web.UI.Page
    {
        ...
        protected void btnPesquisar_DirectClick(object sender, Ext.Net.DirectEventArgs e)
        {
            ...
            if (objUsuario != null && objUsuario.DadosPessoais != null)
            {
        ...
        protected void LinhaGrid_DirectClick(object sender, DirectEventArgs e)
        {
            ...
            if (e.ExtraParams["IDObjeto"] == "btnPermissao")
            {

                string URL = "CadastroPermissaoUsuario.aspx?qUser=" + IDTabela;

                ExibirModalCadastro("Permissões do usuário", URL, 400, 780, true, false, Icon.Key);
            }
