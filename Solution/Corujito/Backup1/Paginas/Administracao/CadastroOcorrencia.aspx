<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CadastroOcorrencia.aspx.cs" Inherits="Corujito.Apresentacao.Paginas.Administracao.CadastroOcorrencia" %>
		...
		<ext:Panel ID="PanelCadastro" runat="server" Title="Cadastro de Ocorrência" Icon="ApplicationAdd" AnchorHorizontal="100%" Frame="true" >
			...
			<Items>
				...
				<ext:FormPanel ID="FormPanelCadastro" runat="server" LabelWidth="130" ButtonAlign="Right" Border="false" LabelAlign="Left" PaddingSummary="10px 15px 20px" >
	    			...
	    			<Items>
						<ext:NumberField ID="txtIdOcorrencia" runat="server" FieldLabel="IdOcorrencia" AnchorHorizontal="30%"
                             BlankText="O campo IdOcorrencia é Obrigatório." Disabled="True" Hidden="true">
						</ext:NumberField>

						<ext:TextArea ID="txtOcorrencia" runat="server" FieldLabel="Ocorrência" AnchorHorizontal="95%" MaxLength="1000" 
                            Truncate="true" AllowBlank="false" BlankText="O campo Ocorrência é Obrigatório." Disabled="False">
						</ext:TextArea>

                        <ext:TextArea ID="txtProvidencia" runat="server" FieldLabel="Providência" AnchorHorizontal="95%" MaxLength="1000" 
                            Truncate="true" AllowBlank="false" BlankText="O campo Providência é Obrigatório." Disabled="False">
						</ext:TextArea>
					</Items>
