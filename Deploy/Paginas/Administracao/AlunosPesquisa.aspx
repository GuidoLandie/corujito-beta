<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AlunosPesquisa.aspx.cs" Inherits="Corujito.Apresentacao.Paginas.Administracao.AlunosPesquisa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <u>Home > Administração > Cadastro Aluno</u>
    ...
    <br />
     ...
     <ext:Panel ID="pnlTituloPagina" runat="server" AnchorHorizontal="100%" Title="Ocorrências" Icon="User" Frame="true" Border="true"
		...
		<ext:Panel ID="PanelParametrosPesquisa" runat="server" Title="Parâmetros da Pesquisa" Icon="Magnifier" AnchorHorizontal="100%"
                            ...
                            <Items>
                                <ext:Container ID="container2" runat="server" Layout="FormLayout" ColumnWidth="0.35" >
                                  ...
                                  <ext:Container ID="container4" runat="server" Layout="FormLayout" ColumnWidth="0.3" >
                                    <Items>
                                        <ext:TextField ID="txtRA"           runat="server" FieldLabel="RA"    Width="140"      MaxLength="20" />
                                    </Items>
                                </ext:Container>
                            </Items>
                        </ext:Container>
			...
			<ext:GridPanel ID="GridPesquisaCRJPessoa" runat="server" StripeRows="true" Title="Resultados da pesquisa - Cadastro de Alunos" Icon="Table" TrackMouseOver="true"
						...
						<Reader>
							<ext:JsonReader>
								<Fields>
                                    ...
                                    <ext:RecordField Name="IdAluno"        Mapping="IdAluno"          Type="Int" />
				...
				<ColumnModel ID="ColumnModel1" runat="server">
					<Columns>
                        ...
                        <ext:ImageCommandColumn Width="25" ColumnID="BotaoOcorrencia" Fixed="true">
							<Commands>
								<ext:ImageCommand CommandName="btnOcorrencia" Icon="Cancel" Text="">
									<ToolTip Title="Ocorrência:" Text="Lançar ocorrência" />
								</ext:ImageCommand>
							</Commands>
						</ext:ImageCommandColumn>
                        <ext:ImageCommandColumn Width="25" ColumnID="BotaoEmail" Fixed="true">
							<Commands>
								<ext:ImageCommand CommandName="btnEmail" Icon="EmailGo" Text="">
									<ToolTip Title="Email:" Text="Enviar email para o responsável" />
								</ext:ImageCommand>
							</Commands>
						</ext:ImageCommandColumn>
				...
				<DirectEvents>
					<Command OnEvent="LinhaGrid_DirectClick">
						<EventMask ShowMask="true" MinDelay="10" />
						<ExtraParams>
							<ext:Parameter Value="record.data.IdAluno" Mode="Raw" Name="IdentificadorRegistroTabela"></ext:Parameter>
